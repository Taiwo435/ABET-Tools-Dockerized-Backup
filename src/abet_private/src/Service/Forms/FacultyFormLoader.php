...
class CoordinatorFormLoader
{
    ...
    public function getReportSections(\PDO $pdo, int $program_id): array {
        $stmt = $pdo->prepare("
    ...
    public function getProgramInfo(\PDO $pdo, int $program_id): ?array {
        $stmt = $pdo->prepare("
    ...
    public function getProgramSelectionKey(?array $program): ?string {
        if (!$program) {
            return null;
        }
    ...
    public function decodeJsonIfNeeded($value) {
    ...
    public function normalizePageName(string $pageName): string {
        $aliases = [
    ...
    public function loadOutcomeAssessmentRows(\PDO $pdo, int $program_id): array {
        $stmt = $pdo->prepare("
    ...
    public function loadAssessmentSummaryRows(\PDO $pdo, int $program_id): array {
        $stmt = $pdo->prepare("
    ...
    public function loadFormData($pageName, $request) {
