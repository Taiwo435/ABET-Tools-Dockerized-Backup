...
<link rel="stylesheet" href="<?php echo htmlspecialchars($reviewCssPath); ?>">

<div class="center-div">
  <div class="form-holder review-form-holder">
    <div class="top-bar">
      <h2 class="form-title"><?php echo htmlspecialchars($reviewTitle); ?></h2>
      <div class="page-select-actions">
        <button class="form-button form-button-return"
                type="button"
                onclick="window.location.assign('<?php echo htmlspecialchars($formBasePath); ?>')">
