...
final class Version20260319051758 extends AbstractMigration
{
    ...
    {
        return 'Get the database to the state of v0.2.0';
    }
...
SQL);
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE login_events');
        // reportgen tables
        $this->addSql('DROP TABLE courses');
        $this->addSql('DROP TABLE programs');
        $this->addSql('DROP TABLE student_admission_requirements');
        $this->addSql('DROP TABLE admission_major_map ');
        // form tables
        // criterion 1
        $this->addSql('DROP TABLE faculty_info');
        $this->addSql('DROP TABLE faculty_workload');
        $this->addSql('DROP TABLE faculty_vitae');
        // criterion 2
        $this->addSql('DROP TABLE peo_review');
        // criterion 4
        $this->addSql('DROP TABLE outcome_assessment');
        $this->addSql('DROP TABLE outcome_attainment_criteria');
        $this->addSql('DROP TABLE outcome_attainment_level');
        $this->addSql('DROP TABLE assessment_summary');
        $this->addSql('DROP TABLE outcome_met_percentages');
        $this->addSql('DROP TABLE continuous_improvement');
        $this->addSql('DROP TABLE concentration_courses');
        // criterion 5
        $this->addSql('DROP TABLE curriculum');
        $this->addSql('DROP TABLE curriculum_peo_alignment');
        $this->addSql('DROP TABLE course_pre_co_requisite');
        $this->addSql('DROP TABLE cv_information');
        // criterion 7
        $this->addSql('DROP TABLE facility_rooms');
        // criterion 8
        $this->addSql('DROP TABLE scai_staff');
        // Appendix C
        $this->addSql('DROP TABLE uto_lab_computers');
        $this->addSql('DROP TABLE uto_lab_software');
        $this->addSql('DROP TABLE scia_lab_computers');
        $this->addSql('DROP TABLE scia_printers');
        $this->addSql('DROP TABLE scia_brickyard_software');
        // Appendix D
        $this->addSql('DROP TABLE program_enrollment');
        $this->addSql('DROP TABLE personnel');
        // Appendix E
        $this->addSql('DROP TABLE assessment_roles');
        $this->addSql('DROP TABLE assessment_constituency');
