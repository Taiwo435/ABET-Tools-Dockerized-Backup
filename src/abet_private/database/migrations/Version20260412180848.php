...
final class Version20260412180848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course_syllabi MODIFY instructor_name JSON;');

        $this->addSql('ALTER TABLE course_syllabi SET textbook = NULL;');
        $this->addSql('ALTER TABLE course_syllabi MODIFY textbook JSON;');

        $this->addSql('ALTER TABLE course_syllabi SET specific_goals = NULL;');
        $this->addSql('ALTER TABLE course_syllabi MODIFY specific_goals JSON;');

        $this->addSql('ALTER TABLE course_syllabi SET student_outcomes = NULL;');
        $this->addSql('ALTER TABLE course_syllabi MODIFY student_outcomes JSON;');

        $this->addSql('ALTER TABLE course_syllabi SET topics_covered = NULL;');
        $this->addSql('ALTER TABLE course_syllabi MODIFY topics_covered JSON;');
