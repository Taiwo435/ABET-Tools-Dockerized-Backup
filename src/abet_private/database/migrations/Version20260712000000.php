...
CREATE TABLE syllabus_template_submissions (
    ...
    working_revision_id INT DEFAULT NULL,
    based_on_revision_id INT DEFAULT NULL,
...
SQL);
        ...
        $this->addSql('ALTER TABLE syllabus_template_submissions ADD CONSTRAINT FK_SYLLABUS_SUBMISSION_OWNER FOREIGN KEY (submitted_by_user_id) REFERENCES users (id) ON DELETE RESTRICT');
        ...
        $this->addSql('ALTER TABLE syllabus_template_submissions ADD CONSTRAINT FK_SYLLABUS_WORKING_REVISION FOREIGN KEY (working_revision_id) REFERENCES syllabus_template_revisions (id) ON DELETE RESTRICT');
        $this->addSql('ALTER TABLE syllabus_template_submissions ADD CONSTRAINT FK_SYLLABUS_BASED_ON_REVISION FOREIGN KEY (based_on_revision_id) REFERENCES syllabus_template_revisions (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE syllabus_template_submissions DROP FOREIGN KEY FK_SYLLABUS_WORKING_REVISION');
        $this->addSql('ALTER TABLE syllabus_template_submissions DROP FOREIGN KEY FK_SYLLABUS_BASED_ON_REVISION');
